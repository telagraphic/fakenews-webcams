...
app.get('/', async (req, res) => {
  ...
  res.render('reader', {
    ...
    HUFFPOST_HEADLINE: news.HUFFPOST_HEADLINE,
    HUFFPOST_STORIES: news.HUFFPOST_STORIES,
    TALKINGPOINTSMEMO_HEADLINE: news.TALKINGPOINTSMEMO_HEADLINE,
    TALKINGPOINTSMEMO_STORIES: news.TALKINGPOINTSMEMO_STORIES,
    DRUDGEREPORT_HEADLINE: news.DRUDGEREPORT_HEADLINE,
    DRUDGEREPORT_STORIES: news.DRUDGEREPORT_STORIES
  });
});
